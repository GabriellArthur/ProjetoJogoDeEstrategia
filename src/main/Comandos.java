...
public class Comandos {
   ...
   public static void comandoAldeaoConstruirMaravilha(int aldeao) {// Fica rodando independete do seu ouro e comida, mas
      ...
      if (aldeao == -1) {
         ...
         if (cultivadores < (Principal.tmFazendas.getRowCount() * (evolucoesPrefeitura.getFazenda() * 5))) {// Limite
            ...
            View.exibirMensagemErro("Erro",
                  "O limite de Aldeaes na fazenda a de: " + evolucoesPrefeitura.getFazenda() * 5 + " Por fazenda");
         }
      }
